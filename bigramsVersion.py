...
print("Naive bayes prediction(bigram)")
...
accuracy = (tp + tn) / (tp + tn + fp + fn)
F1_score = 2 * (precision * recall) / (precision + recall)
print("Regularized logistic regression prediction(bigram)")
print(tn, fp, fn, tp,"precision:",precision,"recall:",recall,"accuracy:",accuracy,"F1_score:",F1_score)
print("---------------------")
...
accuracy = (tp + tn) / (tp + tn + fp + fn)
F1_score = 2 * (precision * recall) / (precision + recall)
print("Classification trees prediction(bigram)")
print(tn, fp, fn, tp,"precision:",precision,"recall:",recall,"accuracy:",accuracy,"F1_score:",F1_score)
print("---------------------")
...
accuracy = (tp + tn) / (tp + tn + fp + fn)
F1_score = 2 * (precision * recall) / (precision + recall)
print("Random Forest prediction(bigram)")
